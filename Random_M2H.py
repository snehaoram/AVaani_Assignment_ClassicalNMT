...
tokenizerM = AutoTokenizer.from_pretrained("path_tp_model--MaBert") #MaBert
...
train_dataset = TensorDataset(
    inputsM_tr_ids, #inputsM_tr_ids, inputsH_tr_ids
    inputsH_tr_ids  #inputsH_tr_ids, inputsM_tr_ids
)

val_dataset = TensorDataset(
    inputsM_vl_ids, #inputsM_vl_ids, inputsH_vl_ids
    inputsH_vl_ids #inputsH_vl_ids, inputsM_vl_ids
)
...
best_model_path = "best_seq2seq_lstm_attention_RANMH.pt"
final_model_path = "final_seq2seq_lstm_attention_RANMH.pt"
