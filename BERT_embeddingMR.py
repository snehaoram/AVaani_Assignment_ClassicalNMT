...
tokenizer = AutoTokenizer.from_pretrained("path_to_model--MaBert") 
model = AutoModelForMaskedLM.from_pretrained("path_to_model--MaBert") 
...
# sample_size = math.ceil(len(marathi_tr) * 0.3)
...
source_sentences = marathi_tr_trun
extract_and_save(source_sentences, "encoder_train_embeddings_MR.npy")  #encoder_train_embeddings_MR_V.npy