...
from BERT_M2H import decode_tokens, bleu_chrf, compute_metrics, build_limited_vocab, tokenize_and_remap

from BERT_M2H import Seq2SeqLSTMAttention
...
checkpoint_path = "best_seq2seq_lstm_attentionM2H.pt" #best_seq2seq_lstm_attention
