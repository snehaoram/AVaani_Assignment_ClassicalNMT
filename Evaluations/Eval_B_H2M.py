...
from BERT_H2M import decode_tokens, bleu_chrf, compute_metrics, build_limited_vocab, tokenize_and_remap

from BERT_H2M import Seq2SeqLSTMAttention
...
checkpoint_path = "best_seq2seq_lstm_attention.pt" #best_seq2seq_lstm_attention
